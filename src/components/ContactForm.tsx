...
export default function ContactForm() {
    ...
    return (
        <div className="p-3 rounded-lg">
            <h1 className="font-eurostile text-yellow-700 text-2xl mb-4">Contact Us</h1>
            <form onSubmit={handleSubmit}>
                ...
                <button type="submit" className="bg-slate-900 font-eurostile hover:bg-slate-700 text-white font-bold py-2 px-4 rounded">
                    Send
                </button>
            </form>
